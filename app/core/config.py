...
class Settings:
    ...
    def __init__(self):
        ...
        self.LANGSMITH_EVALUATION_PROJECT = os.getenv("LANGSMITH_EVALUATION_PROJECT", "llm-evaluation")

        # LangGraph Configuration
        self.LLM_MODEL = os.getenv("LLM_MODEL", "gemini-2.5-flash")
        self.EMBEDDINGS = os.getenv("EMBEDDINGS", "models/embedding-001")
        ...
        self.LLM_EVALUATION_API_KEY = os.getenv("LLM_EVALUATION_API_KEY", "")
        self.EVALUATION_EMBEDDINGS = os.getenv("EVALUATION_EMBEDDINGS", "")
        ...
        self.TEST_USER_EMAIL = os.getenv("TEST_USER_EMAIL", "user2@example.com")
